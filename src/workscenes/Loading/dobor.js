...
const Dobor = ({ words, logs, learnCount, point, countRoutine, logsRoutine, wordsRoutine, doborFinish }) => {
...
const mapDispatchToProps = { countRoutine, logsRoutine, wordsRoutine };
