...
const Profile = ({ wait, wordCount, stat, statweek, statmonth, userRoutine, learnRoutine, countRoutine, vocabularyRoutine, wordsDefaultRoutine, dictDefaultRoutine, statDefaultRoutine }) => {
  ...
  const [initialSnapShot, setInitialSnapShot] = React.useState([270, windowHeight - 360]);
      ...
      >
        <View style={styles.vocabulary}>
          ...
          <View style={styles.progress}>
            ...
            />
            <View style={{ position: 'absolute', top: 9, left: 57, width: 16, height: 15, borderBottomLeftRadius: 8, borderTopLeftRadius: 8, backgroundColor: '#ffff', }} />
