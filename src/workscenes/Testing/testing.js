...
import { wordsRoutine, countRoutine, learnRoutine, vocabularyRoutine, logsRoutine } from '../../store/wordsReducer';
...
const Testing = ({ words, wordsRoutine, countRoutine, logsRoutine, learnRoutine, vocabularyRoutine }) => {
...
const mapDispatchToProps = { wordsRoutine, countRoutine, logsRoutine, learnRoutine, countRoutine, vocabularyRoutine };
